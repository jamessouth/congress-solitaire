...
let make = (~modalBGRand, ~setModalOpen) => {
  <>
    ...
    <div
      className={`${modalBGRand} bg-contain bg-no-repeat aspect-9/16 absolute z-20 top-[10%] bottom-[10%] rounded-3xl p-2 shadow-rules text-cardBlack font-cutive text-sm flex flex-col justify-center`}>
      <button
